...
const Side = () => {
  return (
    <div>
       <aside id="sidebar" class="fixed hidden pt-16 z-20 h-full top-0 left-0   lg:flex flex-shrink-0 flex-col w-64 transition-width duration-75" aria-label="Sidebar">
